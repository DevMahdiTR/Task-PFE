...
import org.taskspfe.pfe.security.jwt.JWTAuthenticationFilter;
import org.taskspfe.pfe.security.jwt.JWTService;
import org.taskspfe.pfe.security.jwt.JwtAuthEntryPoint;
...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(JwtAuthEntryPoint authEntryPoint, LogoutHandler logoutHandler, JWTService jwtService, TokenRepository tokenRepository, CustomUserDetailsService customUserDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/v1/task/admin/**").permitAll()
                .requestMatchers("/api/v1/task/technician/**").permitAll()
    ...
    Filter jwtAuthenticationFilter() {
        return new JWTAuthenticationFilter(jwtService,tokenRepository,customUserDetailsService);
    }
}